...
- The server-rendered page groups up to 24 stops by day and includes localized places, arrival and stay times, tips, walking time, event period or ended status, map links, Open Graph metadata, and schema.org JSON-LD.
